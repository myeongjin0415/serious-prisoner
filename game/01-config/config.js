...
setup.rawTimeline = [
  ...
  },
  {
    ...
    conditionTriggers: [
      ...
      {
        required: ['CLUE_A','CLUE_B', 'CLUE_C', 'CLUE_D'],
        index: 3
      }
    ]
  },
